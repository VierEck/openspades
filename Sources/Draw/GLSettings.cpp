...
DEFINE_SPADES_SETTING(r_blitFramebuffer, "1", "0");
DEFINE_SPADES_SETTING(r_bloom, "1", "0");
DEFINE_SPADES_SETTING(r_cameraBlur, "1", "0");
DEFINE_SPADES_SETTING(r_colorCorrection, "1", "0");
...
DEFINE_SPADES_SETTING(r_depthPrepass, "1", "0");
DEFINE_SPADES_SETTING(r_dlights, "1", "0");
DEFINE_SPADES_SETTING(r_exposureValue, "0");
DEFINE_SPADES_SETTING(r_fogShadow, "0");
DEFINE_SPADES_SETTING(r_fxaa, "1", "0");
...
DEFINE_SPADES_SETTING(r_lens, "1", "0");
DEFINE_SPADES_SETTING(r_lensFlare, "1", "0");
DEFINE_SPADES_SETTING(r_lensFlareDynamic, "1", "0");
DEFINE_SPADES_SETTING(r_mapSoftShadow, "0");
DEFINE_SPADES_SETTING(r_maxAnisotropy, "8");
DEFINE_SPADES_SETTING(r_modelShadows, "1", "0");
...
DEFINE_SPADES_SETTING(r_shadowMapSize, "2048", "32");
...
DEFINE_SPADES_SETTING(r_water, "2", "0");
